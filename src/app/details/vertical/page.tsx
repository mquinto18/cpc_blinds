...
export default function CombiDetailsModal() {
  ...
  const [blindType, setBlindType] = useState("FABRIC-Vertical-Blinds");
    ...
    "FABRIC-Vertical-Blinds": [
      {
        ...
        images: [
          "/vertical/fabric/verticalColor.png",
          "/vertical/fabric/verticalColor1.png",
          "/vertical/fabric/verticalColor2.png",
          "/vertical/fabric/verticalColor3.png",
        ],
      },
    ],
    "PVC-Vertical-Blinds": [
      {
        image: "/vertical/pvc-wood/verticalIMG.png",
        name: "PVC Vertical Blinds",
        images: [
          "/vertical/pvc-wood/verticalColor.png",
          "/vertical/pvc-wood/verticalColor1.png",
          "/vertical/pvc-wood/verticalColor2.png",
          "/vertical/pvc-wood/verticalColor3.png",
          "/vertical/pvc-wood/verticalColor4.png",
        ],
      },
    ],
  };
    ...
    <Modal open={open} onClose={handleClose}>
      ...
      >
        ...
        <FormControl fullWidth className="mt-6">
          ...
          >
            <MenuItem value="FABRIC-Vertical-Blinds">
              FABRIC Vertical Blinds
            </MenuItem>
            <MenuItem value="PVC-Vertical-Blinds">PVC Vertical Blinds</MenuItem>
          </Select>
        </FormControl>
